...
The `gds_env` extends the official [Jupyter Docker Stack](https://jupyter-docker-stacks.readthedocs.io/en/latest/) to include geospatial functionality in both Python and R. For more information on the stack and how to build or install it, check the [Stacks](stacks) and [Guides](guides) sections.
...
The code to generate the `gds_env` is released under a BSD License. More details available on the repository's [license document](https://github.com/darribas/gds_env/blob/master/LICENSE).
